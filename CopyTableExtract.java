        ...
        if (data) {
            ...
            tempRecords = tempRecords.map(row => {
                ...
                return {
                    ...
                    Inquiry: callType === 'Inquiry' ? callType : '',
                    Transactions: callType === 'Transactions' ? callType : '',
                    AccountMaintenance: callType === 'Account Maintenance' ? callType : '',
                    Forms: callType === 'Forms' ? callType : '',
                    Others: callType === 'Others' ? callType : ''
                };
            });
